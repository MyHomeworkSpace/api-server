...
func ParseScheduledMeeting(scheduledMeetingString string, termInfo TermInfo) (*ScheduledMeeting, *time.Time, *time.Time, error) {
	...
	if normalizedMeetingString == "SECTION CANCELLED" || normalizedMeetingString == "TO BE ARRANGED" || normalizedMeetingString == "TBA" || normalizedMeetingString == "TBD" || normalizedMeetingString == "ARRANGED" || normalizedMeetingString == "SCHEDULED INDIVIDUALLY" || normalizedMeetingString == "SCHECULED INDIVIDUALLY" {
		// oof
